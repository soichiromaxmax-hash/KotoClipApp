...
export const HERO_COLORS: Record<number, [string, string]> = {
  ...
  2: ['#0D2540', '#091420'],   // 6〜10: 本棚の部屋（青）
  3: ['#0D2A18', '#081508'],   // 11〜15: 読書の森（緑）
  4: ['#1E1040', '#0E0820'],   // 16〜20: 文脈の街（紫）
  5: ['#060E3A', '#03071E'],   // 21〜25: 言葉の空（深い宇宙色）
  6: ['#301A04', '#1C0E00'],   // 26〜30: Library（金みがかり）
};
